...
const SearchBar = () => {
	...
	return (
		<div className="flex justify-center">
			...
			<button
				type="submit"
				className="-translate-x-1 p-2 text-sm bg-blue-600 rounded-r-lg border border-blue-700 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800"
			>
				<Icon
