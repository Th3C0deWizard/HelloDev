function AuthorArticlesRows(props) {
  ...
  return (
    <tr key={props.id} className="bg-white  hover:bg-[#e6f2ff] text-black">
      ...
      <td className="px-6 py-3 font-medium whitespace-nowrap">
        {props.article.fecha_creacion}
      </td>
      <td className="px-6 py-3 font-medium whitespace-nowrap">
        <a href={props.article.portada} target="_blank">
          <img src="./src/components/assets/portada.png" alt="portada" />
        </a>
      </td>
      <td className="px-6 py-3 font-medium whitespace-nowrap">
        <a href={props.article.archivo} target="_blank">
          <img src="./src/components/assets/pdf.png" alt="pdf" />
        </a>
      </td>
      <td className="px-6 py-3 font-medium whitespace-nowrap">
