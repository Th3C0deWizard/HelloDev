  ...
  return (
    <div className="bg-white  rounded-tl-3x rounded-b-3xl shadow-xl hover:shadow-2xl hover:transform hover:scale-105 duration-300">
      ...
      <div className="p-2 pb-3 bg-[#f8f9fa]">
        ...
        <p className="mt-4  text-[#343a40]">{article.author}</p>
        <div className="mt-1 flex items-end justify-between">
          ...
          <Link
            ...
            className="flex items-center space-x-1.5 rounded-lg bg-[#F4D73B] px-4 py-1.5 text-white duration-100 hover:bg-[#ffdc16] shadow-l"
          >
            <Icon
