  ...
  <React.StrictMode>
    <div>
      ...
      <section class=" bg-slate-900 p-8" >
        <h1 class="grid place-items-center mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Historial de Articulos</h1>
