    ...
    <div>
      ...
      <section class="grid grid-cols-3 gap-2 bg-slate-900 p-2 pt-10 pb-20">
        <h1 class="col-start-2 ml-20 text-4xl font-extrabold dark:text-white">
            Menú <span class="bg-amber-200 text-amber-600 text-2xl font-semibold mr-2 px-2.5 py-0.5 rounded ml-2">Editor</span>
        </h1>
        ...
        <div class="col-start-1 grid place-items-center mx-5 mt-8">
            ...
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">Articulos recibidos</p>
        ...
        <div class="grid place-items-center mx-5 mt-8 mr-10s">
            <svg class="w-20 h-20 text-amber-400" fill="currentColor" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">Historial de todos los articulos de la revista</p>
            <a href="#" class="font-medium text-amber-400 hover:underline mt-4">Go ahead</a>
        </div>
        ...
        <div class="grid place-items-center mx-5 mt-8">
            ...
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">Gestión articulos recibidos y evaluados</p>
            <a href="#" class="font-medium text-amber-400 hover:underline mt-4">Go ahead</a>
        </div>
