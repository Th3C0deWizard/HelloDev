    ...
    <div>
      ...
      <section class="grid grid-cols-3 gap-1 bg-slate-900">
        ...
        <div class="col-span-2 grid grid-cols-4 grid-rows-11 gap-1 m-6 ">
          <img
            class="col-start-3 w-10 h-10 p-1 rounded-full ring-2 ring-gray-300 dark:ring-gray-500"
          ...
          {/*Input nombre*/}
          <textarea
            class="ml-12 col-start-3 col-span-2 row-span-5"
          ...
          <select class="col-start-1 h-10" required>
            {" "}
            {/*Input nacionalidad*/}
