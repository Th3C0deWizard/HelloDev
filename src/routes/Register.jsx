		...
		<>
			...
			>
				<div className="grid grid-cols-5">
					...
					<div className="mt-12 mb-5 mr-10 col-start-4 col-span-2 rounded-lg shadow bg-slate-800 bg-opacity-90">
							...
							<form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
								<div className="grid grid-cols-2 gap-4">
									...
									<div>
										...
										<select
											className="col-start-1 h-10 sm:text-sm rounded-lg block w-full p-2.5 bg-white border-gray-600 text-black focus:ring-blue-500 focus:border-blue-500"
											defaultValue={"df"}
											onChange={handleChange}
										>
											<option value="df">Escoje una nación</option>
								...
								<button
									type="submit"
									className="w-full text-white bg-amber-500 hover:bg-amber-400 hover:scale-105 transition font-medium rounded-lg text-md p-2"
								>
									Crear Cuenta
								</button>
